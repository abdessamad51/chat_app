...
const CardListFriend = ({friends,handleClick,handleSendingInvitation,loading}) => {
    return (
        ...
        {  loading && friends.map((friend) => (
            friend.is_friend ?
            <Link href="#" onClick={(e) => handleClick(e,friend.conversation_id,friend.participant_full_name,friend.participant_image) } key={friend.id} className="card border-0 text-reset" >
                    ...
                    <div className="row gx-5">
                        ...
                        {friend.invitation_status === null && (
                            <img
                                ...
                                style={{ width: "40px" }}
                                onClick={(e) => {
                                    handleSendingInvitation(e,friend.id,friend.participant_full_name);
                                }}
                                className="add-img"
